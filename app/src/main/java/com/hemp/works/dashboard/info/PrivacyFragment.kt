...
class PrivacyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate<FragmentPrivacyBinding>(
            inflater, R.layout.fragment_privacy, container, false).apply {
        }
        ...
        binding.text.text =  HtmlCompat.fromHtml( requireContext().getString(R.string.privacy_desc), HtmlCompat.FROM_HTML_MODE_LEGACY)
        return binding.root
    }
