...
class SingleOrderAdminFragment: BaseFragment<FragmentSingleOrderBinding>() {
    ...
    private val mSingleOrderAdminAdapter by lazy {
        SingleOrderAdminAdapter(requireContext())
    }
                ...
                is Result.Success -> {
                    ...
                    it.data.apply {
                        mBinding.apply {
                            ...
                            mSingleOrderAdminAdapter.addItems(it.data.order)
                            ...
                            mBinding.idRvOrders.apply {
                                ...
                                adapter = mSingleOrderAdminAdapter
                            }
